g++ solvers.c common_funcs.c test_system/test_system.c -I./square -o test_system.exe -Wshadow -Winit-self -Wredundant-decls -Wcast-align -Wundef -Wfloat-equal -Winline -Wunreachable-code ^
