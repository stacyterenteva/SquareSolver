g++ main.c ui.c solvers.c common_funcs.c trainer.c -o square_solver.exe -Wshadow -Winit-self -Wredundant-decls -Wcast-align -Wundef -Wfloat-equal -Winline -Wunreachable-code ^
